...
export function registerStylingTools(server, bridge) {
    server.tool("list_styles", "List available paint, text, effect, and grid styles in the file", {
    ...
    server.tool("apply_style", "Apply a named style to a node by style ID", {
    ...
    server.tool("set_styles", "Set visual styles on a node: fills, strokes, effects, typography, opacity, corner radius", {
        nodeId: z.string().describe("Target node ID"),
