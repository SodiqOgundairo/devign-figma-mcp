...
export function registerVariableTools(server: McpServer, bridge: WsBridge) {
  server.tool(
    "list_variables",
    "List all local variable collections and their variables (design tokens)",
    {
  ...
  server.tool(
    "bind_variable",
    "Bind a variable (design token) to a node property",
    {
