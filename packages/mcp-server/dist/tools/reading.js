...
export function registerReadingTools(server, bridge) {
    server.tool("read_current_page", "Read the current Figma page structure. Returns a tree of nodes with IDs, names, types, positions, and sizes.", {
    ...
    server.tool("get_node_by_id", "Get detailed info about a specific node by its ID", {
