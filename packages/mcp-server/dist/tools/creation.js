...
export function registerCreationTools(server, bridge) {
    server.tool("create_frame", "Create a new frame (artboard) on the Figma canvas", {
    ...
    server.tool("add_rectangle", "Add a rectangle to the canvas", {
    ...
    server.tool("add_ellipse", "Add an ellipse/circle to the canvas", {
        width: z.number().positive(),
        height: z.number().positive(),
        x: z.number().default(0),
        y: z.number().default(0),
    ...
    server.tool("add_text", "Add a text node to the canvas. Font defaults to Inter Regular.", {
    ...
    server.tool("add_shape", "Add a polygon, star, or line to the canvas", {
